...
Sandwich sudoku sharpens the same scanning habit you already use here. Watch single candidates fall in the [hints tool](/), work a full board step by step in the [step-by-step sudoku guide](/guides/sudoku-step-by-step), and generate fresh puzzles at your level in the [maker](/maker). When you want to stretch the habit on a bigger canvas, [16x16 mega sudoku](/mega) runs the identical row, column, and box logic with sixteen digits and four-cell boxes.
