...
Arrow sudoku rewards the same candidate thinking you already practice here. Warm up with a full board solve in our [step-by-step sudoku guide](/guides/sudoku-step-by-step), watch single candidates fall in the [hints tool](/), and generate fresh puzzles at your level in the [maker](/maker). If you want more room to stretch the habit, [16x16 mega sudoku](/mega) runs the identical logic on a bigger canvas.
