    ...
    <footer className="mt-16 border-t border-gray-200 bg-white print:hidden">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-8 sm:grid-cols-4">
          <div className="sm:col-span-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-gray-900">fastsudoku</span>
            </div>
            <p className="mt-2 max-w-xs text-sm text-gray-500">
              Free online sudoku hints, puzzle generator, and step-by-step
              solving — play, print, and learn, no sign-up.
            </p>
          </div>
          <div>
            <h4 className="mb-3 text-sm font-medium text-gray-900">Puzzles</h4>
            <ul className="space-y-2 text-sm text-gray-500">
              <li><Link href="/maker" className="hover:text-gray-900">Puzzle Maker</Link></li>
              <li><Link href="/mega" className="hover:text-gray-900">Mega 16×16</Link></li>
              <li><Link href="/kids" className="hover:text-gray-900">Kids 4×4 / 6×6</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="mb-3 text-sm font-medium text-gray-900">About</h4>
            <ul className="space-y-2 text-sm text-gray-500">
              <li><Link href="/guides" className="hover:text-gray-900">Guides</Link></li>
              <li><Link href="/guides/tags" className="hover:text-gray-900">Tags</Link></li>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-2 border-t border-gray-100 pt-6 text-xs text-gray-400 sm:flex-row">
          <span>&copy; {year} fastsudoku. All rights reserved.</span>
