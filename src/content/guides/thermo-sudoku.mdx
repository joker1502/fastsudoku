...
Thermo sudoku rewards the same candidate thinking you already practice here. Watch single candidates fall in the [hints tool](/), warm up on a full board in the [step-by-step sudoku guide](/guides/sudoku-step-by-step), and generate fresh puzzles at your level in the [maker](/maker). When you want more room to stretch the habit, [16x16 mega sudoku](/mega) runs the identical logic on a bigger canvas.